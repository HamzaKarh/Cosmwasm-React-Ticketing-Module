...
export interface TaskReadOnlyInterface {
  contractAddress: string;
  getCount: () => Promise<GetCountResponse>;
}
export class TaskQueryClient implements TaskReadOnlyInterface {
  client: LCDClient;
  contractAddress: string;
...
export interface TaskInterface extends TaskReadOnlyInterface {
  contractAddress: string;
...
export class TaskClient extends TaskQueryClient implements TaskInterface {
  client: LCDClient;
